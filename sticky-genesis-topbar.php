...
function sticky_genesis_topbar_admin_msg() {
	...
	// }
	if ( is_admin() ) {
		echo '<div class="notice notice-info is-dismissible"><p><b>Sticky Genesis Topbar</b> is going to change it\'s chemistry in the next update so take a backup.</p></div>';
	}
}
